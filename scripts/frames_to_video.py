...
if __name__ == "__main__":
    ...
    parser.add_argument("--imgs_path", type=str, default="../outputs/2023-02-26/22-57-32/inference", help="path to imgs")
    parser.add_argument("--vid_path", type=str, default="../outputs/videos/2.mp4", help="path to vid")
